...
const mockMessages: UIMessage[] = [
  {
    ...
    senderId: 'customer_1',
    recipientId: 'user_1',
    content: 'Hi! I need 5 gallons of spring water delivered today.',
    messageType: 'text',
    status: 'read',
    direction: 'inbound',
  ...
  },
  {
    ...
    senderId: 'customer_2',
    recipientId: 'user_1',
    content: 'Do you have water dispensers available?',
    messageType: 'text',
    status: 'read',
    direction: 'inbound',
...
const defaultTemplates: MessageTemplate[] = [
  {
    ...
    category: 'UTILITY',
    content: 'Hi {{customerName}}! Welcome to Stella Water Delivery. How can we help you today?',
  ...
  },
  {
    ...
    category: 'UTILITY',
    content: 'Your water delivery is on the way! Our driver will arrive in approximately {{estimatedTime}} minutes.',
...
export const mockMessageUtils = {
  ...
  generateTestMessage(conversationId: string): UIMessage {
    const testMessages = [
      ...
      'I need water delivery for my office.',
      'What are your delivery times?',
      'Do you have spring water available?',
